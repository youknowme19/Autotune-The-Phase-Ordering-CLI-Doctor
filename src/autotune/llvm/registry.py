...
KNOWN_PASS_CLASSIFICATIONS: Dict[str, PassType] = {
    ...
    "aggressive-instcombine": PassType.FUNCTION,
    ...
    "loop-flatten": PassType.FUNCTION,
    "loop-interchange": PassType.FUNCTION,
    "loop-unroll-and-jam": PassType.FUNCTION,
    "loop-distribute": PassType.FUNCTION,
    "loop-versioning": PassType.FUNCTION,
    ...
    "gvn-hoist": PassType.FUNCTION,
    "gvn-sink": PassType.FUNCTION,
